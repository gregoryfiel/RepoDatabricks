...
# MAGIC %md
# MAGIC ### Mostrando o histórico das transações no Delta Lake - tabela
# MAGIC Compras
# MAGIC
...
# MAGIC %sql
# MAGIC CREATE TABLE delta. `/temporario/hive/clonado` CLONE delta.
# MAGIC `/user/hive/warehouse/compras`
